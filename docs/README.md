...
Arbeitsregeln: [AGENTS.md](../AGENTS.md), [CONTRIBUTING.md](../CONTRIBUTING.md). Checkliste nach jeder Änderung in der [Phasen-Datei](./phasen/00.1-app-scaffolds.md) setzen; neuer Scope: Punkt aufnehmen und `*(ergänzt)*` markieren.
