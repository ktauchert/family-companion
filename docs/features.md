...
| **Kalender** | Termine, Wiederholungen | Web + App; KW-Ansicht, EventCards, View-Modal (Phase 2.2); Habits sichtbar für Haushalt; Import später |
| **Todos** | Wer macht was | Web + App; TodoCards, Modal (Phase 2.2); Fälligkeit, Zuweisung, Wiederholung, Habits |
| **Einkaufslisten nach Thema** | Getrennt abhaken | Web + App; Default-Themen + **eigene Listen pro Haushalt** (Phase 2.3); Autocomplete aus Historie ([ADR 0006](./adr/0006-kategorisierte-einkaufslisten.md)) |
